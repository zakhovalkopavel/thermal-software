...
class DocumentBuilder:
    ...
    def build_document(self, pages_data: List[Dict], source_file: str, total_pages: int):
        """
        Build and save complete document.json
        ...
        total_graphics = sum(
            ...
            for content in page.get('content_sequence', [])
        ...
        logger.info(f"Document saved: {json_path}")
