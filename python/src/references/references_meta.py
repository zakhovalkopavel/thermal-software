"""
references.references_meta — Machine-readable metadata for every RefKey entry.

Fields mirror the TypeScript REFERENCES_META in:
...
class ReferenceMeta(TypedDict):
    """Metadata record for one literature reference."""
...
REFERENCES_META: dict[RefKey, ReferenceMeta] = {
    ...
    RefKey.NASA9:         {'index': 23, 'name': 'Burcat & Ruscic — ANL-05/20 (2005) — NASA-9 polynomial coefficients',           'year': '2005',    'url': 'https://publications.anl.gov/anlpubs/2005/07/53802.pdf'},
    ...
    RefKey.BurcatELTE:    {'index': 25, 'name': 'Burcat, Ruscic, Goos — Extended Third Millennium Thermodynamic Database (ELTE)', 'year': 'ongoing', 'url': 'https://respecth.elte.hu/burcat.php'},
}
